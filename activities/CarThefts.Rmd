...
```{r}
car_thefts |> summarise(mean = mean(count), sd = sd(count))
```
...
The distribution is skewed to the right. A majority of the data lies between the blue lines/standard deviation.
