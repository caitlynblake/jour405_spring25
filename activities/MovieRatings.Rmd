...
I would reject the null hypothesis because the chi-square statistic is larger than the critical value. This means that observed frequency is different than the expected frequency.
