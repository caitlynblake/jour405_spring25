...
```{r}
matches |> summarise(correlation = cor(fouls, goal_diff, method = "pearson"))
```
small number = almost no relationship
...
There is close to no correlation between fouls and goal diff. The correlation is 0.018 which is extremely low. 
