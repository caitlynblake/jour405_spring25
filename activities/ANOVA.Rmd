...
Yes - the p values are very small meaning that the differences are significant.

2. Which specific college types differ from each other?
Public and private colleges have higher SAT scores than community. Public colleges have lower scores than public, this gap is less significant than the others. 

3. How large are these differences?
Private vs community: 366.96 point difference
Public vs community: 292.55 point difference
Public vs private: 74.40 point difference
