...
```{r}
violent_rates <- crimes |> mutate(violent_rate = violent_crime_total/population *10000)
property_rate <- crimes |> mutate(property_rate = property_crime_total/population *10000)
```
...
Property crime was highest in 1980. Violent crime was highest in 1992. Both were lowest in 2020. 2020 being the lowest isn't all that surprising as most people were not leaving their homes/going out often.
