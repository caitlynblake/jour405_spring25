...
Weight of 3.04 means they are weighed more heavily, while 0.23 not as much

3. Why might some respondents be weighted more heavily than others?
If that kind of respondent (someone who doesn't vote, uninterested in politics, doesn't have a cell phone/access to internet) does not appear as often as others, they may be assigned more weight 
...
Weighted percentages could mean that some groups are over/under represented in the data, leading to reduced accuracy.
...
Weighting could help counteract bias but can affect accuracy. People who don't/are less likely to vote may be under represented.
