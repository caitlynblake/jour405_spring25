...
Yes because the f-statistic and p-value suggest that the model is significant.
...
Point scored has the most impact because it has the highest level of correlation. The least impactful would be Takeaways.
...
I would use this to compare how the independent variables affect the dependent variables. I could also use this to determine what teams are best at, and what they need to improve.
