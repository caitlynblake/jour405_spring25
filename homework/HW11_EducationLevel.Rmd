...
People may be more or less inclined to participate in a survey based on different factors. For example, people with higher education may be more inclined to participate.
...
Voters with less education tend to be more unsure about their voting choices
...
Among college educated voters, there were more people who answered "yes"  and "unsure", while the people you said "no" decreased. For high school educated individuals, "yes" answers decreased, while "unsure" and "no" increased. Individuals with less college education were more likely to answer "no" and "unsure".

2. Why might the weighted results be considered more accurate than the unweighted results?

It may be more accurate as the results are more balanced.
...
People who attended high school or less
...
Yes, often differences are easier to see on a chart or graph
...
People with less education are less inclined to vote, while those with higher education are more likely to participate. When weights are applied, the difference does not seem to be as large.This could mean that the unweighted results are not represented accurately.
...
It is important for journalists to understand survey weighting in order to convey accurate statistics and results.

2. How might the differences between weighted and unweighted results affect how you would report on this data?

Unweighted results may over or under represent a specific group which could lead to inaccurate results. On the other hand, weighted results are often more accurate as it corrects for over or under represented groups.
...
I would want more info about how the poll was conducted and how weights were applied.
