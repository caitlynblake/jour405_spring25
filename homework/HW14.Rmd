...
Summerfield has the highest probability, most likely because of it's high Black population.
...
I noticed that lowest scores are still 50% and above.
...
Langley Park, Wheaton, and Adelphi are the most diverse. Wheaton is Montgomery County, while the other two cities are in PG County. The least diverse city, Lake Shore, is in Anne Arundel County.
...
Summerfield's majority Black population overshadows low racial diversity

Despite the city having a predominantly Black population, Summerfield's racial diversity remains low. According to U.S. Census data, there's an 87% chance that any two randomly chosen residents belong to the same race.
