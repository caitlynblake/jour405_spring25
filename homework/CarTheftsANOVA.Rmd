...
There was a rise in thefts in 2023, the rates doubled.The thefts went on to decrease but they were still higher than pre-spike.
...
There was a rise in thefts at the end of 2022 and remained higher the next year.

Title: Car thefts increased in 2023 and have remained higher than previous years.
...
- **Null Hypothesis (H0)**: Throughout the three time periods, the mean of theft rates have remained the same.

- **Alternative Hypothesis (H1)**: The car theft rates are different in at least one of the time periods.
...
The p-value is less than 0.05 which means the null hypothesis is rejected. The f-value of 218 proves that the difference between time periods is greater than within each period.
...
Statistical analysis proves a significant drop in car thefts after the initial spike.

The rates of car thefts rose in 2023, but with a drop after a period of increased thefts. Thefts decreased by an average of 20 thefts when compared to before the increase period.
