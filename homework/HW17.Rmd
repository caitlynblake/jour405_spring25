...
The strongest correlation is the unemploymnt percentage and the percentage of white residents. The most linear correlation would be percent employed, percent with bachelor's degree or higher, and media age. 
...
I believe that this model is useful. The f-statistic is 16.55 and p-value is less than .05, meaning that the model is significant. There is also a low residual standard of error.
...
I think model 2 is the most significant because it has a higher r-square of .82. 
...
# Model 3
model3 <- lm(turnout ~ pct_white + income + median_age + pct_bachelors_higher, data = md_turnout)
summary(model3)
...
I would explore how different demographics affect voter turnout.
