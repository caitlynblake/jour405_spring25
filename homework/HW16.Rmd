...
The lines show a negative relationship, the graph shows that higher FARMS percentage is linked to lower percentage of math scores that exceed expectations.
...
The coefficients, p-value, and the new r-squared value.
...
The p-value is much lower than .05 which means that there is a significantly significant relationship. The new r-square value is .6734, meaning that 67.34% of the FARMS percentage explains the math scores. The higher FARMS percentage is associated with lower math scores.
...
Wayside and Stedwick have the largest differences. Wayside has higher scores and overperforms, while Stedwick is the opposite and underperforms. Wayside's zip code is 20854 - majority white population (59%), followed by Asian (22%), with Black and Hispanic making up the lowest percentage. Stedwick's zip code is 20886 - majority Hispanic population (35%), followed by Black (23%), White (23%), and Asian (14%). This area has a higher rate of children living in poverty that Wayside. 
...
Wayside is in an area with a very low poverty rate, and overperformed. This cannot be said of Stedwick, which underperformed. This data would validate the trend. A possible story could explore how to help students beyone FARMS percentages. 
