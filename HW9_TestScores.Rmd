...
The test scores are improving but not by much.
...
The new mean has increased and the standard deviation has decreased. This means that the new scores are closer to the average.
...
The p-value is very small. The program is affecting the scores but it is not clear by how much. I would say that the program is likely to have had a positive impact on the scores.
...
Headline: New reading program may be boosting test scores

Lede: Third grade test scores have increased since last semester, following the implementation of a new reading program. Statistical evidence suggests that this new program is likely contributing to the higher test scores.
